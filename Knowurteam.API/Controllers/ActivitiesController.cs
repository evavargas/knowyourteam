...
namespace Knowurteam.API.Controllers
{
    ...
    public class ActivitiesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetActivity(int id)
        {
            ...
            var activity = _mapper.Map<PhotoForReturnDto>(activityFromRepo);

            return Ok(activity);
        }
        [HttpPost]
        public async Task<IActionResult> AddActivity(int userId, [FromForm]ActivityForCreationDto activityForCreationDto)
        {
